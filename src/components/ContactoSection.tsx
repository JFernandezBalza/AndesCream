    ...
    <section className='py-16 px-4 bg-white min-h-[80vh]'>
      <div className='max-w-xl mx-auto text-center'>
        ...
        <p className='text-xl text-gray-600 mb-10'>
          Estamos aquí para ayudarte. Completa los datos y elige cómo prefieres
          enviarnos tu mensaje o idea.
        </p>
        ...
        >
          ...
          <div className='flex space-x-4 pt-4'>
            ...
            <button
              type='submit'
              // CLASES MODIFICADAS: border-2, bg-white, text-pink-400
              className='flex-1 flex items-center justify-center py-3 px-4 border-2 border-pink-400 rounded-md shadow-sm text-lg font-medium text-pink-400 bg-white hover:bg-pink-50 hover:border-pink-500 hover:text-pink-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-pink-400 transition duration-300'
            ...
            <button
              ...
              className='flex-1 flex items-center justify-center py-3 px-4 border-2 border-emerald-400 rounded-md shadow-sm text-lg font-medium text-emerald-400 bg-white hover:bg-emerald-50 hover:border-emerald-500 hover:text-emerald-500 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-400 transition duration-300'
